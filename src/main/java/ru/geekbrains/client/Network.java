...
public class Network {
    ...
    private static final String socketServerHost = "localhost";
    private static final int socketServerPort = 64646;
    ...
    public static void connect() {
        try {
            socket = new Socket(socketServerHost, socketServerPort);
